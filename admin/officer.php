            ...
            <table class="table table-striped table-hover table-dark">
                ...
                $result = $conn->query($sql);
	                ...
	                <tr class="<?php if(isset($classname)) echo $classname;?>">
	                    ...
	                    <td><a href="officerdelete.php?io_id=<?php echo $row["io_id"]; ?>">Delete</a></td>
                        <td><a href="officerupdate.php?io_id=<?php echo $row["io_id"]; ?>">Update</a></td>
                        <td><a href="officerrec.php">ADD</a></td>
	                </tr>
	            <?php
	            $i++;
	            }
