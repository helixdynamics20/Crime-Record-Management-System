...
<body>
    ...
    <section class="enterprise">
        <!-- <h1 class="text-center"><select class="form-control-sm"><option value="undefined" selected="">Search By</option><option value="12" selected="">ID</option></select><input type="search" class="form-control-sm" />
        <button class="btn btn-primary cbtn" type="button">Search</button>
        </h1> -->
            ...
            <table class="table table-striped table-hover table-dark">
                ...
                $result = $conn->query($sql);
	                ...
	                <tr class="<?php if(isset($classname)) echo $classname;?>">
	                    ...
	                    <td><a href="soldelete.php?sol_id=<?php echo $row["sol_id"]; ?>">Delete</a></td>
                        <td><a href="solupdate.php?sol_id=<?php echo $row["sol_id"]; ?>">Update</a></td>
                        <td><a href="sectionoflawrec.php">ADD</a></td>
	                </tr>
	            <?php
	            $i++;
	            }
