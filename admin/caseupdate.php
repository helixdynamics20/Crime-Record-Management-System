...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE caseoutcome set case_outcome_id='" . $_POST['case_outcome_id'] . "', case_id='" . $_POST['case_id'] . "', section_of_law='" . $_POST['section_of_law'] . "', status='" . $_POST['status'] . "' ,details='" . $_POST['details'] . "' WHERE case_outcome_id='" . $_POST['case_outcome_id'] . "'");
    ...
    <section >
        ...
        <div class="form-container">
            ...
            <a href="Case.php">Case</a>
                ...
                <h1 id="record_vis">Update Case Details</h1>
