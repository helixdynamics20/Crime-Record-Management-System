...
<body>
    ...
    <section class="enterprise">
        <!-- <h1 class="text-center"><select class="form-control-sm"><option value="undefined" selected="">Search By</option><option value="12" selected="">FIR Number</option><option value="13">Petitioner Name</option><option value="14">Victim Name</option></select><input type="search" class="form-control-sm" />
            <button
            ...
            <table class="table table-striped table-hover table-dark">
                ...
                $result = $conn->query($sql);
	                ...
	                <tr class="<?php if(isset($classname)) echo $classname;?>">
	                    <td><?php echo $row["fir_num"]; ?></td>
                        <td><?php echo $row["petitioner_name"]; ?></td>
	                    <td><?php echo $row["victim_name"]; ?></td>
	                    <td><?php echo $row["date_filled"]; ?></td>
	                    <td><?php echo $row["time_filled"]; ?></td>
                        <td><?php echo $row["date_incident"]; ?></td>
                        <td><?php echo $row["time_incident"]; ?></td>
                        <td><?php echo $row["place_incident"]; ?></td>
                        <td><?php echo $row["accused_name"]; ?></td>
	                    <td><a href="firdelete.php?fir_num=<?php echo $row["fir_num"]; ?>">Delete</a></td>
                        <td><a href="firupdate.php?fir_num=<?php echo $row["fir_num"]; ?>">Update</a></td>
                        <td><a href="firrec.php">ADD</a></td>
	                </tr>
	            <?php
	            $i++;
	            }
