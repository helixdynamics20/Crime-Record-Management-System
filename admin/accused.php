            ...
            <table class="table table-striped table-hover table-dark">
                ...
                $result = $conn->query($sql);
	                ...
	                <tr class="<?php if(isset($classname)) echo $classname;?>">
                        ...
                        <td><?php echo $row["locked_at"]; ?></td>
	                    <td><a href="acudelete.php?accused_id=<?php echo $row["accused_id"]; ?>">Delete</a></td>
                        <td><a href="acuupdate.php?accused_id=<?php echo $row["accused_id"]; ?>">Update</a></td>
                        <td><a href="accusedrec.php">ADD</a></td>
	                </tr>
	            <?php
	            $i++;
	            }
