...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE victim set victim_id='" . $_POST['victim_id'] . "', name='" . $_POST['name'] . "', father_name='" . $_POST['father_name'] . "', gender='" . $_POST['gender'] . "' ,age='" . $_POST['age'] . "', status='" . $_POST['status'] . "' ,contact='" . $_POST['contact'] . "',street='" . $_POST['street'] . "',city='" . $_POST['city'] . "',state='" . $_POST['state'] . "' WHERE accused_id='" . $_POST['accused_id'] . "'");
$message = "Record Modified Successfully";
}
$result = mysqli_query($conn,"SELECT * FROM victim WHERE victim_id='" . $_GET['victim_id'] . "'");
    ...
    <section >
        ...
        <div class="form-container">
            ...
            <a href="victim.php">Victim</a>
                ...
                <h1 id="record_vis">Update Victim Details</h1>
                <h2 class="text-center" id="record_vis"><br></h2>
                <div class="form-group"><input class="form-control" name="victim_id" placeholder="ID" type="text" value="<?php echo $row['victim_id']; ?>"></div>
                ...
                <div class="form-group"><input class="form-control" name="situation" placeholder="Situations" type="text" value="<?php echo $row['situation']; ?>"></div>
