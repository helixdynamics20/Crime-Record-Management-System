...
if(isset($_POST['Submit']))
{
    ...
    $caseid=$_POST['caseid'];
    $sectionlaw=$_POST['sectionlaw'];
    $status=$_POST['status'];
    $details=$_POST['details'];
   
                     
        $sql= "INSERT INTO caseoutcome(case_id, section_of_law, status, details) 
                        
                        VALUES('$caseid','$sectionlaw', '$status',$details)";
        ...
        {
            header("location: caseoutcome.php");
        }
...
<body>
    ...
    <div class="register-photo">
        <div class="form-container">
            <form method="post">
                <h1 id="record_vis">Enter Case Outcome Details</h1>
                ...
                <div class="form-group"><input class="form-control" name="section_of_law" placeholder="Section Of Law" type="text"></div>
