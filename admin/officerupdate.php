...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE officer set io_id='" . $_POST['io_id'] . "', name='" . $_POST['name'] . "', father_name='" . $_POST['father_name'] . "', gender='" . $_POST['gender'] . "' ,age='" . $_POST['age'] . "',contact='" . $_POST['contact'] . "', rank='" . $_POST['rank'] . "', date_of_appointment ='" . $_POST['date_of_appointment '] . "',street='" . $_POST['street'] . "',city='" . $_POST['city'] . "',state='" . $_POST['state'] . "' WHERE io_id='" . $_POST['io_id'] . "'");
$message = "Record Modified Successfully";
}
$result = mysqli_query($conn,"SELECT * FROM officer WHERE io_id='" . $_GET['io_id'] . "'");
    ...
    <section >
        ...
        <div class="form-container">
            ...
            <a href="officer.php">officer</a>
                ...
                <h1 id="record_vis">Update Accused Details</h1>
                <h2 class="text-center" id="record_vis"><br></h2>
                <div class="form-group"><input class="form-control" name="io_id" placeholder="ID" type="text" value="<?php echo $row['io_id']; ?>"></div>
                ...
                <div class="form-group"><input class="form-control" name="rank" placeholder="Rank" type="text" value="<?php echo $row['rank']; ?>"></div>
                <div class="form-group"><input class="form-control" name="date_of_appointment" placeholder="Date of Appointment" type="date" value="<?php echo $row['date_of_appointment']; ?>"></div>
                ...
                <div class="form-group"><input class="form-control" name="email"placeholder="email"  type="email" value="<?php echo $row['email']; ?>"></div>
