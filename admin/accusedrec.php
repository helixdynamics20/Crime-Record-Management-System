...
if(isset($_POST['Submit']))
{
    ...
    $State=$_POST['state'];
        ...
        $sql= "INSERT INTO accused(name, father_name, gender, age, status, contact,street, city, state) 
                        
                        VALUES('$Name','$Father', '$Gender',$Age,'$Status',$Contact,'$Street','$City','$State')";
...
<body>
    ...
    <div class="register-photo">
        <div class="form-container">
            <form method="post">
                <h1 id="record_vis">Enter Accused Details</h1>
                ...
                <div class="form-group"><input class="form-control" name="status" placeholder="Status" type="text"></div>
                <div class="form-group"><input class="form-control" name="contact" placeholder="Contact" type="tel"></div>
                <div class="form-group"><input class="form-control" name="street" placeholder="Street" type="text"></div>
