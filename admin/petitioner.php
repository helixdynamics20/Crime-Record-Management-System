...
<body>
    ...
    <section class="enterprise">
        <!-- <h1 class="text-center"><select class="form-control-sm"><option value="undefined" selected="">Search By</option><option value="12" selected="">Petitioner ID</option><option value="13">Name</option><option value="14">Father Name</option></select><input type="search" class="form-control-sm" />
            <button
            ...
            <table class="table table-striped table-hover table-dark">
                ...
                $result = $conn->query($sql);
	                ...
	                <tr class="<?php if(isset($classname)) echo $classname;?>">
	                    <td><?php echo $row["petitioner_id"]; ?></td>
                        ...
                        <td><?php echo $row["filed_at"]; ?></td>
	                    <td><a href="petdelete.php?petitioner_id=<?php echo $row["petitioner_id"]; ?>">Delete</a></td>
                        <td><a href="petupdate.php?petitioner_id=<?php echo $row["petitioner_id"]; ?>">Update</a></td>
                        <td><a href="petitionerrec.php">ADD</a></td>
	                </tr>
	            <?php
	            $i++;
	            }
