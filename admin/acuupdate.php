...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE accused set accused_id='" . $_POST['accused_id'] . "', name='" . $_POST['name'] . "', father_name='" . $_POST['father_name'] . "', gender='" . $_POST['gender'] . "' ,age='" . $_POST['age'] . "', status='" . $_POST['status'] . "' ,contact='" . $_POST['contact'] . "',street='" . $_POST['street'] . "',city='" . $_POST['city'] . "',state='" . $_POST['state'] . "' WHERE accused_id='" . $_POST['accused_id'] . "'");
$message = "Record Modified Successfully";
}
$result = mysqli_query($conn,"SELECT * FROM accused WHERE accused_id='" . $_GET['accused_id'] . "'");
...
<body>
    ...
    <section >
        ...
        <div class="form-container">
            ...
            <a href="accused.php">Accused</a>
            </div>
                <h1 id="record_vis">Update Accused Details</h1>
                <h2 class="text-center" id="record_vis"><br></h2>
                <div class="form-group"><input class="form-control" name="accused_id" placeholder="ID" type="text" value="<?php echo $row['accused_id']; ?>"></div>
