            ...
            <table class="table table-striped table-hover table-dark">
                ...
                $result = $conn->query($sql);
	                ...
	                <tr class="<?php if(isset($classname)) echo $classname;?>">
	                    <td><?php echo $row["investigation_id"]; ?></td>
                        <td><?php echo $row["case_id"]; ?></td>
	                    <td><?php echo $row["investigation_officer"]; ?></td>
	                    <td><?php echo $row["date_of_start"]; ?></td>
	                    <td><?php echo $row["date_of_end"]; ?></td>
                        <td><?php echo $row["details"]; ?></td>
	                    <td><a href="invdelete.php?investigation_id=<?php echo $row["investigation_id"]; ?>">Delete</a></td>
                        <td><a href="invupdate.php?investigation_id=<?php echo $row["investigation_id"]; ?>">Update</a></td>
                        <td><a href="investigaterec.php">ADD</a></td>
	                </tr>
	            <?php
	            $i++;
	            }
