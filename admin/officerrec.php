...
if(isset($_POST['Submit']))
{
    ...
    $Email=$_POST['email'];
        ...
        $sql= "INSERT INTO officer(name, father_name, gender, age, contact, rank, date_of_appointment,street,city,state,email) 
                        
                        VALUES('$name','$father_name', '$gender',$age,$contact,'$rank','$date_of_appointment','$Street','$City','$State','$Email')";
...
<body>
    ...
    <div class="register-photo">
        <div class="form-container">
            <form method="post">
                <h1 id="record_vis">Enter Officer Details</h1>
                <h2 class="text-center" id="record_vis"><br></h2>
                <div class="form-group"><input class="form-control" name="name" placeholder="Name" type="text"></div>
                <div class="form-group"><input class="form-control" name="father_name" placeholder="Father Name" type="text"></div>
                <div class="form-group"><input class="form-control" name="gender" placeholder="Gender" type="text"></div>
                <div class="form-group"><input class="form-control" name="age" placeholder="Age" type="number"></div>
                <div class="form-group"><input class="form-control" name="contact" placeholder="Contact" type="tel"></div>
                <div class="form-group"><input class="form-control" name="rank" placeholder="Rank" type="text"></div>
                <div class="form-group"><input class="form-control" name="date_of_appointment" placeholder="Date of Appointment" type="date"></div>
                <div class="form-group"><input class="form-control" name="street" placeholder="Street" type="text" value="<?php echo $row['street']; ?>"></div>
                <div class="form-group"><input class="form-control" name="city" placeholder="City" type="text"></div>
                <div class="form-group"><input class="form-control" name="state"placeholder="State"  type="text"></div>
