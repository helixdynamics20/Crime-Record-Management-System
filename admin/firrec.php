...
if(isset($_POST['Submit']))
{
    ...
    $petitioner=$_POST['petitioner_name'];
    $victim=$_POST['victim_name'];
    $datefilled=$_POST['date_filled'];
    $dateincident=$_POST['date_incident'];
    $timeincident=$_POST['time_incident'];
    $placeincident=$_POST['place_incident'];
    $accussedname=$_POST['accused_name'];
    
                     
        $sql= "INSERT INTO fir(petitioner_name, victim_name, date_filled, date_filled, time_incident , place_incident , accused_name ) VALUES(' $petitioner',' $victim', $datefilled,$dateincident, $timeincident,'$placeincident','$accussedname')";
...
<body>
    ...
    <div class="register-photo">
        <div class="form-container">
            <form method="post">
                <h1 id="record_vis">Enter FIR Details</h1>
                <h2 class="text-center" id="record_vis"><br></h2>
                <div class="form-group"><input class="form-control" name="petitioner_name" placeholder="Petitioner Name" type="text"></div>
                <div class="form-group"><input class="form-control" name="victim_name" placeholder="Victim Name" type="text"></div>
                <div class="form-group"><input class="form-control" name="date_filled" placeholder="Date Filled" type="date"></div>
                <div class="form-group"><input class="form-control" name="date_incident" placeholder="Date Incident" type="date"></div>
                <div class="form-group"><input class="form-control" name="time_incident" placeholder="Time Incident" type="time"></div>
                <div class="form-group"><input class="form-control" name="place_incident" placeholder="Place Incident" type="text"></div>
                <div class="form-group"><input class="form-control" name="accused_name" placeholder="Accused Name" type="text"></div>
