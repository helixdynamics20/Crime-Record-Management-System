...
if(isset($_POST['Submit']))
{
    ...
    $detail=$_POST['detail'];
        ...
        $sql= "INSERT INTO sectionoflaw(section_of_law, sentence , detail) 
                        
                        VALUES('$section_of_law',$sentence, '$detail')";
        ...
        {
            header("location:sectionoflaw.php");
        }
...
<body>
    ...
    <div class="register-photo">
        <div class="form-container">
            <form method="post">
                <h1 id="record_vis">Enter Section Of Law Details</h1>
                <h2 class="text-center" id="record_vis"><br></h2>
                <div class="form-group"><input class="form-control" name="section_of_law" placeholder="Section" type="text"></div>
                <div class="form-group"><input class="form-control" name="sentence" placeholder="Sentence" type="number"></div>
                <div class="form-group"><input class="form-control" name="detail" placeholder="Detail" type="text"></div>
