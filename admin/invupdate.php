...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE investigate set investigation_id='" . $_POST['investigation_id'] . "', case_id='" . $_POST['case_id'] . "', investigation_officer='" . $_POST['investigation_officer'] . "', date_start='" . $_POST['date_start'] . "' ,date_end='" . $_POST['date_end'] . "', other_detail='" . $_POST['other_detail'] . "'  WHERE investigation_id='" . $_POST['investigation_id'] . "'");
$message = "Record Modified Successfully";
}
$result = mysqli_query($conn,"SELECT * FROM investigate WHERE investigation_id='" . $_GET['investigation_id'] . "'");
...
<body>
    ...
    <section >
        ...
        <div class="form-container">
            ...
            <a href="investigate.php">investigate</a>
            </div>
                <h1 id="record_vis">Update investigation Details</h1>
                <h2 class="text-center" id="record_vis"><br></h2>
                <div class="form-group"><input class="form-control" name="investigation_id" placeholder="ID" type="text" value="<?php echo $row['investigation_id']; ?>"></div>
                <div class="form-group"><input class="form-control" name="case_id" placeholder="Case ID" type="number"></div>
                <div class="form-group"><input class="form-control" name="investigation_officer" placeholder="Officer Name" type="text"></div>
                <div class="form-group"><input class="form-control" name="date_start" placeholder="Date Of Start" type="date"></div>
                <div class="form-group"><input class="form-control" name="date_end" placeholder="Date Of End" type="date"></div>
                <div class="form-group"><input class="form-control" name="other_detail" placeholder="Details" type="time"></div>
