...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE sectionoflaw set sol_id='" . $_POST['sol_id'] . "', name='" . $_POST['name'] . "', father_name='" . $_POST['father_name'] . "', gender='" . $_POST['gender'] . "' ,age='" . $_POST['age'] . "', status='" . $_POST['status'] . "' ,contact='" . $_POST['contact'] . "',street='" . $_POST['street'] . "',city='" . $_POST['city'] . "',state='" . $_POST['state'] . "' WHERE accused_id='" . $_POST['accused_id'] . "'");
$message = "Record Modified Successfully";
}
$result = mysqli_query($conn,"SELECT * FROM sectionoflaw WHERE sol_id='" . $_GET['sol_id'] . "'");
...
<body>
    ...
    <section >
        ...
        <div class="form-container">
            ...
            <a href="sectionoflaw.php">Section Of Law</a>
            </div>
                <h1 id="record_vis">Update SOL Details</h1>
                <h2 class="text-center" id="record_vis"><br></h2>
                <div class="form-group"><input class="form-control" name="sol_id" placeholder="ID" type="text" value="<?php echo $row['sol_id']; ?>"></div>
                <div class="form-group"><input class="form-control" name="section_of_law" placeholder="Section" type="text" value="<?php echo $row['section_of_law']; ?>"></div>
                <div class="form-group"><input class="form-control" name="sentence" placeholder="Sentence" type="number" value="<?php echo $row['sentence']; ?>"></div>
                <div class="form-group"><input class="form-control" name="detail" placeholder="Detail" type="text" value="<?php echo $row['detail']; ?>"></div>
