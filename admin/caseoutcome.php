...
<body>
    ...
    <section class="enterprise">
        <!-- <h1 class="text-center"><select class="form-control-sm"><option value="undefined" selected="">Search By</option><option value="12" selected="">Case Outcome ID</option><option value="13">Case ID</option></select><input type="search" class="form-control-sm" /><button class="btn btn-primary cbtn"
                type="button">Search</button></h1> -->
        <div class="table-responsive">
            <table class="table table-striped table-hover table-dark">
                <thead>
                    <tr>
                        <th>Case Outcome ID</th>
                        <th>Case ID</th>
                ...
                $result = $conn->query($sql);
	                ...
	                <tr class="<?php if(isset($classname)) echo $classname;?>">
	                    <td><?php echo $row["case_outcome_id"]; ?></td>
                        <td><?php echo $row["case_id"]; ?></td>
	                    <td><?php echo $row["section_of_law"]; ?></td>
	                    <td><?php echo $row["status"]; ?></td>
	                    <td><?php echo $row["details"]; ?></td>
	                    <td><a href="codelete.php?case_outcome_id=<?php echo $row["case_outcome_id"]; ?>">Delete</a></td>
                        <td><a href="coupdate.php?case_outcome_id=<?php echo $row["case_outcome_id"]; ?>">Update</a></td>
                        <td><a href="caseoutcomerec.php">ADD</a></td>
	                </tr>
	            <?php
	            $i++;
	            }
