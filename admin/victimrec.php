...
if(isset($_POST['Submit']))
{
    ...
    $state=$_POST['state'];
        ...
        $sql= "INSERT INTO Victim(name, father_name , gender,age,contact,situation ,street,city,state ) 
                        
                        VALUES('$name',$father_name, '$gender',$age, $contact,'$situation',' $street',''$city','$state')";
...
<body>
    ...
    <div class="register-photo">
        <div class="form-container">
            <form method="post">
                <h1 id="record_vis">Enter Victim Details</h1>
                ...
                <div class="form-group"><input class="form-control" name="situation" placeholder="Situations" type="text"></div>
