...
if(isset($_POST['Submit']))
{
    ...
    $investigation_oficer= $_POST['investigation_oficer'];
    $date_of_start= $_POST['date_of_start'];
    $date_of_end= $_POST['date_of_end'];
    $other_details= $_POST['other_details'];
   
                     
        $sql= "INSERT INTO investigate(case_id, investigation_officer, date_of_start, date_of_end, other_details) VALUES($case_id,'$investigation_oficer', $date_of_start,$date_of_end,'$other_details')";
...
<body>
    ...
    <div class="register-photo">
        <div class="form-container">
            <form method="post">
                <h1 id="record_vis">Enter Investigation Details</h1>
