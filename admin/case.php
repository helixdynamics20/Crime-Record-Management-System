            ...
            <table class="table table-striped table-hover table-dark">
                ...
                $i=0;
	                ...
	                <tr class="<?php if(isset($classname)) echo $classname;?>">
	                    ...
	                    <td><a href="casedelete.php?accused_id=<?php echo $row["case_id"]; ?>">Delete</a></td>
                        <td><a href="caseupdate.php?accused_id=<?php echo $row["case_id"]; ?>">Update</a></td>
                        <td><a href="caserec.php">ADD</a></td>
	                </tr>
	            <?php
	            $i++;
	            }
