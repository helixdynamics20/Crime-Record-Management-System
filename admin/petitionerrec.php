...
if(isset($_POST['Submit']))
{
    ...
    $State=$_POST['state'];
        ...
        $sql= "INSERT INTO petitioner(name, father_name, gender, age, contact, street, city, state) 
                        
                        VALUES('$Name','$Father', '$Gender',$Age,$Contact,'$Address','$City','$State')";
        ...
        {
            header("location:petitioner.php");
        }
...
<body>
    ...
    <div class="register-photo">
        <div class="form-container">
            <form method="post">
                <h1 id="record_vis">Enter Petitioner Details</h1>
