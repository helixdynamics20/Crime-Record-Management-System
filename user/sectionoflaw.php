...
<body>
    ...
    <section class="enterprise">
        <h1 class="text-center"><select class="form-control-sm"><option value="undefined" selected="">Search By</option><option value="12" selected="">ID</option></select><input type="search" class="form-control-sm" /><button class="btn btn-primary cbtn" type="button">Search</button></h1>
        <div
            ...
            <table class="table table-striped table-hover table-dark">
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<tr><td>" . $row["sol_id"]. "</td><td>" . $row["section_of_law"] . "</td><td>"
                    . $row["sentence"]. "</td><td>" . $row["detail"] . "</td></tr>";
                }
                echo "</table>";
                }
                $conn->close();
