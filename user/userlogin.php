...
<body>
    ...
    <div class="login-dark">
        <form method="post" target="_self" action="controlpanel.html">
            <h2 class="sr-only">Login Form</h2>
            <div class="illustration"><i class="fas fa-user-tie" style="color: rgb(11,70,140);"></i></div>
            <div class="form-group"><input class="form-control" type="email" name="email" placeholder="Email"></div>
            <div class="form-group"><input class="form-control" type="password" name="password" placeholder="Password"></div>
            <div class="form-group"><button class="btn btn-block" type="submit" style="color: rgb(255,255,255);">Log In</button></div><a class="forgot" href="#">Forgot your email or password?</a></form>
    </div>
