        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover table-dark">
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<tr><td>" . $row["fir_num"]. "</td><td>" . $row["petitioner_name"] . "</td><td>"
                    . $row["victim_name"]. "</td><td>" . $row["date_filled"] . "</td> <td>" . $row["time_filled"] . "</td> <td>" . $row["date_incident"] . "</td>
                    <td>" . $row["time_incident"] . "</td> <td>" . $row["place_incident"] . "</td> <td>" . $row["accused_name"] . "</td></tr>";
                }
                echo "</table>";
                }
                $conn->close();
