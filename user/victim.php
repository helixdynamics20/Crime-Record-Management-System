        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover table-dark">
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<tr><td>" . $row["victim_id"]. "</td><td>" . $row["name"] . "</td><td>"
                    . $row["father_name"]. "</td><td>" . $row["gender"] . "</td>  <td>" . $row["age"] . "</td>
                    <td>" . $row["contact"] . "</td> <td>" . $row["situation"] . "</td> <td>" . $row["street"] . "</td>
                    <td>" . $row["city"] . "</td> <td>" . $row["state"] . "</td> <td>" . $row["accident at"] . "</td></tr>";
                }
                echo "</table>";
                }
                $conn->close();
